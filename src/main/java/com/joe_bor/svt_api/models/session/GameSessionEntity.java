...
public class GameSessionEntity {
    ...
    @CollectionTable(name = "game_session_pending_events", joinColumns = @JoinColumn(name = "game_session_id"))
    @Column(name = "event_id")
    private Set<Long> pendingEventIds = new HashSet<>();

    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(name = "game_session_fired_location_events", joinColumns = @JoinColumn(name = "game_session_id"))
    @Column(name = "event_id")
